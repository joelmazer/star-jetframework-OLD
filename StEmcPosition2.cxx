...
//------------------------------------------------------------------------------
StThreeVectorF StEmcPosition2::getPosFromVertex( const StThreeVectorF& position, int TowerId ) const
{
...
//------------------------------------------------------------------------------
Float_t StEmcPosition2::getThetaFromVertex( const StThreeVectorF& vertex, int TowerId ) const
{
  StThreeVectorF p=getPosFromVertex(vertex, TowerId );
  return p.theta();
}
//------------------------------------------------------------------------------
Float_t StEmcPosition2::getEtaFromVertex( const StThreeVectorF& vertex, int TowerId ) const
{
  StThreeVectorF p=getPosFromVertex(vertex, TowerId );
  return p.pseudoRapidity();
}
//------------------------------------------------------------------------------
Float_t StEmcPosition2::getPhiFromVertex( const StThreeVectorF& vertex, int TowerId ) const
{
  StThreeVectorF p=getPosFromVertex(vertex, TowerId );
  return p.phi();
}
